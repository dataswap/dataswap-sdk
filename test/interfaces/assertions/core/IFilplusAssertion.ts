...
export interface IFilplusAssertion {
     ...
     */
    getDatasetRuleMaxReplicasInCountryAssertion(countryCode: number, expectCount: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    datasetRuleDefaultMaxReplicasPerCountryAssertion(expectCount: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    datasetRuleMaxProportionOfMappingFilesToDatasetAssertion(expectProportion: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    datasetRuleMinTotalReplicasPerDatasetAssertion(expectCount: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    datasetRuleMaxTotalReplicasPerDatasetAssertion(expectCount: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    datacapRulesMaxAllocatedSizePerTimeAssertion(expectSize: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    datacapRulesMaxRemainingPercentageForNextAssertion(expectPercentage: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    isCompliantRuleGeolocationAssertion(regions: number[], countrys: number[], citys: number[][], expectHas: boolean): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    isCompliantRuleMaxProportionOfMappingFilesToDatasetAssertion(mappingFilesSize: number, sourceSize: number, expectHas: boolean): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    isCompliantRuleTotalReplicasPerDatasetAssertion(dataPreparers: string[][], storageProviders: string[][], regions: number[], countrys: number[], citys: number[][], expectHas: boolean): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    isCompliantRuleMinSPsPerDatasetAssertion(requirementValue: number, totalExists: number, uniqueExists: number, expectHas: boolean): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    isCompliantRuleMaxReplicasPerSPAssertion(value: number, expectHas: boolean): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    setDatasetRuleDefaultMaxReplicasPerCountryAssertion(newValue: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    setDatasetRuleMaxReplicasInCountryAssertion(countryCode: number, newValue: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    setDatasetRuleMaxProportionOfMappingFilesToDatasetAssertion(newValue: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    setDatasetRuleMinTotalReplicasPerDatasetAssertion(newValue: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    setDatasetRuleMaxTotalReplicasPerDatasetAssertion(newValue: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    setDatacapRulesMaxAllocatedSizePerTimeAssertion(newValue: number): Promise<void>
     ...
     * @returns {Promise<void>}
     */
    setDatacapRulesMaxRemainingPercentageForNextAssertion(newValue: number): Promise<void>
}
