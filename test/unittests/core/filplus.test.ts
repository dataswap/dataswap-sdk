...
describe("filplus", () => {
    ...
    it("setDatasetRuleDefaultMaxReplicasPerCountry", async function () {
        await filplusAssertion.setDatasetRuleDefaultMaxReplicasPerCountryAssertion(5)
    })
    ...
    it("setDatasetRuleMaxProportionOfMappingFilesToDataset", async function () {
        await filplusAssertion.setDatasetRuleMaxProportionOfMappingFilesToDatasetAssertion(5)
    })
    ...
    it("setDatasetRuleMinTotalReplicasPerDataset", async function () {
        await filplusAssertion.setDatasetRuleMinTotalReplicasPerDatasetAssertion(5)
    })
    ...
    it("setDatasetRuleMaxTotalReplicasPerDataset", async function () {
        await filplusAssertion.setDatasetRuleMaxTotalReplicasPerDatasetAssertion(5)
    })
    ...
    it("setDatacapRulesMaxAllocatedSizePerTime", async function () {
        await filplusAssertion.setDatacapRulesMaxAllocatedSizePerTimeAssertion(5)
    })
    ...
    it("setDatacapRulesMaxRemainingPercentageForNext", async function () {
        await filplusAssertion.setDatacapRulesMaxRemainingPercentageForNextAssertion(5)
    })
    ...
    it("isCompliantRuleMaxProportionOfMappingFilesToDataset", async function () {
        await filplusAssertion.isCompliantRuleMaxProportionOfMappingFilesToDatasetAssertion(40, 10000, true)
        await filplusAssertion.isCompliantRuleMaxProportionOfMappingFilesToDatasetAssertion(400, 10000, false)
    })
    ...
    it("isCompliantRuleGeolocation", async function () {
        let requirements = this.sharedData.generator.generateDatasetRequirements(5, 1)

        await filplusAssertion.isCompliantRuleGeolocationAssertion(requirements.regionCodes, requirements.countryCodes, requirements.cityCodes, true)
        await filplusAssertion.isCompliantRuleGeolocationAssertion([1, 1, 1, 1, 1], requirements.countryCodes, requirements.cityCodes, false)
        await filplusAssertion.isCompliantRuleGeolocationAssertion(requirements.regionCodes, [1, 1, 1, 1, 1], requirements.cityCodes, false)
        await filplusAssertion.isCompliantRuleGeolocationAssertion(requirements.regionCodes, requirements.countryCodes, [[1], [1], [1], [1], [1]], false)
    })
    ...
    it("isCompliantRuleTotalReplicasPerDataset", async function () {
        ...
        await filplusAssertion.isCompliantRuleTotalReplicasPerDatasetAssertion(
            requirements.dataPreparers, requirements.storageProviders, requirements.regionCodes, requirements.countryCodes, requirements.cityCodes, true)
        await filplusAssertion.isCompliantRuleTotalReplicasPerDatasetAssertion(
            requirements.dataPreparers, requirements.storageProviders, [1, 1, 1, 1, 1], requirements.countryCodes, requirements.cityCodes, false)
        await filplusAssertion.isCompliantRuleTotalReplicasPerDatasetAssertion(
            requirements.dataPreparers, requirements.storageProviders, requirements.regionCodes, [1, 1, 1, 1, 1], requirements.cityCodes, false)
        await filplusAssertion.isCompliantRuleTotalReplicasPerDatasetAssertion(
            requirements.dataPreparers, requirements.storageProviders, requirements.regionCodes, requirements.countryCodes, [[1], [1], [1], [1], [1]], false)

        let dataPreparers = [requirements.dataPreparers[0], requirements.dataPreparers[0], requirements.dataPreparers[0], requirements.dataPreparers[0], requirements.dataPreparers[0]]
        let storageProviders = [requirements.storageProviders[0], requirements.storageProviders[0], requirements.storageProviders[0], requirements.storageProviders[0], requirements.storageProviders[0]]
        await filplusAssertion.isCompliantRuleTotalReplicasPerDatasetAssertion(
            dataPreparers, requirements.storageProviders, requirements.regionCodes, requirements.countryCodes, requirements.cityCodes, false)
        await filplusAssertion.isCompliantRuleTotalReplicasPerDatasetAssertion(
            requirements.dataPreparers, storageProviders, requirements.regionCodes, requirements.countryCodes, requirements.cityCodes, false)
    })
    ...
    it("isCompliantRuleMinSPsPerDataset", async function () {
        await filplusAssertion.isCompliantRuleMinSPsPerDatasetAssertion(10, 5, 5, true)
        await filplusAssertion.isCompliantRuleMinSPsPerDatasetAssertion(10, 8, 1, false)
    })
    ...
    it("isCompliantRuleMaxReplicasPerSP", async function () {
        await filplusAssertion.isCompliantRuleMaxReplicasPerSPAssertion(10, true)
        await filplusAssertion.isCompliantRuleMaxReplicasPerSPAssertion(11, false)
    })
})